...
RUN sed -i -e '''/from modules import launch_utils/a\import os''' /content/stable-diffusion-webui/launch.py && \
    ...
    sed -i -e 's/typing.Optional\[dict\[str, str\]\]/typing.Optional\[typing.Dict\[str, str\]\]/g' /content/stable-diffusion-webui/extensions/sd-webui-3d-open-pose-editor/scripts/openpose_editor.py
